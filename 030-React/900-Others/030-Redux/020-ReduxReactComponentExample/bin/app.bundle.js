...
var ActionKey;
(function (ActionKey) {
    ActionKey["DO_SOMETHING"] = "DO_SOMETHING";
    ActionKey["INCREASE_COUNTER"] = "ADD_COUNTER";
    ActionKey["DECREASE_COUNTER"] = "DECREASE_COUNTER";
...
exports.Reducer = function (state, action) {
    switch (action.type) {
        case ActionKey_1.ActionKey.INCREASE_COUNTER:
            if (action.n) {
                state = { counter: state.counter + action.n };
            }
            return state;
        case ActionKey_1.ActionKey.DECREASE_COUNTER:
            if (action.n) {
                state = { counter: state.counter - action.n };
            }
            return state;
